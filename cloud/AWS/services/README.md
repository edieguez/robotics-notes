...
- [`S3` - Simple Storage Service](services/s3.md)
- [`S3` Glacier - Long-term storage](services/s3-glacier.md)
- [`EBS` - Elastic Block Storage](services/ebs.md)
- [`EFS` - Elastic File System](services/efs.md)
- [`Amazon FSx for Windows File server` - Windows file server](services/fsx.md)
- [`AWS snowball` - Physical data transport](services/snowball.md)
- [`AWS snowmobile` - Physical data transport](services/snowmobile.md)
